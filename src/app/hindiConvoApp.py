...
user_input = st.chat_input("💬 अपने प्रश्न पूछें या Type your question...")
    ...
    with st.chat_message("assistant"):
        with st.spinner("Thinking..."):
            ...
            if lang == 'hi':
                ...
                answer_hi = GoogleTranslator(source='auto', target='hi').translate(answer_en)
                st.markdown(answer_hi)
                st.session_state.messages.append({"role": "assistant", "content": answer_hi})
            else:
